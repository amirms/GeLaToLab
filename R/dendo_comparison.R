...
enrichedTop <- pam(myEnrichedDist, noc)
top <- pam(myDist, noc)
...
#Text Area
 "caretLine", "autoIndent" , "findMatchingBracket" ,  #"selectToMatchingBracket", #"lineHighlight" ,"highlight", "indentLine" ,
...
#User Interface
#"preferredLayoutSize" , 
"processKeyEvent",  "toolbar", "menubar" ,
#"showPopupMenu", 
"needFullRepaint", "focusedComponent", #"addDockableWindow", "actionBar",
"editPane", 
#"searchField","OPEN_DIALOG", "SAVE_DIALOG",

#Core
"settingsDirectory", "zipFile", "fileVFS", #"createVFSSession", , #"sourceFile" , 
...
#plugins
"activatePlugin"  , #"addPluginJAR", #"PluginOptions", 
# "download", 
...
#Search & Replace
"doBackwardSearch", "doForwardSearch", 
